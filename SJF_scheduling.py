class SJF: 
    ...
    def processData(self, no_of_processes):  
        ...
        for i in range(no_of_processes):  
            temporary = [] #TAKE INPUT FOR DIFFERENT PROCESSES 
...
#CALCULATE TURNAROUND TIME  FOR EACH PROCESS & AVGERAGE TURNAROUND TIME
...
#CALCULATE WAITING TIME  FOR EACH PROCESS & AVGERAGE WAITING TIME
